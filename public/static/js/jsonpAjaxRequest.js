...
(function () {
    ...
    const eleTopicId = getElementsByCssStr('#req-topic-id')[0];
    const topicId = eleTopicId && eleTopicId.value;
    const eleAK = getElementsByCssStr('#req-ak')[0];
    const AK = eleAK && eleAK.value;
    diyHttpRequest({
        time: 10000,
